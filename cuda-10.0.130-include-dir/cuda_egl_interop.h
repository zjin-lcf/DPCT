 ...
 * \endcode
 *
 * For ::cudaEglFrame of type ::cudaEglFrameTypePitch, the ::cudaPitchedPtr::ptr passed in
 * ::cudaEglFrame must point to the start address of the memory allocated through ::cudaMalloc
 * or acquired from another producer through EGLStream pipeline.
 *
