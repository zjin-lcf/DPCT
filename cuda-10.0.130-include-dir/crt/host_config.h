...
#if (__ICC != 1500 && __ICC != 1600 && __ICC != 1700 && __ICC != 1800) || !defined(__GNUC__) || !defined(__LP64__)

#error -- unsupported ICC configuration! Only ICC 15.0, ICC 16.0, ICC 17.0 and ICC 18.0 on Linux x86_64 are supported!

#endif /* (__ICC != 1500 && __ICC != 1600 && __ICC != 1700 && __ICC != 1800) || !__GNUC__ || !__LP64__ */
...
#if (__PGIC__ != 18 && !(__PGIC__ == 99 && __PGIC_MINOR__ == 99))
#error -- unsupported pgc++ configuration! Only pgc++ 18 on Linux x86_64 are supported!
#endif
...
#pragma message("support for this version of Microsoft Visual Studio has been deprecated! Only the versions between 2013 and 2017 (inclusive) are supported!")

#endif /* _MSC_VER < 1700 || _MSC_VER >= 1920 || _MSC_VER >= 1600 && _MSC_VER < 1800 */
