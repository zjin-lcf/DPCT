...
typedef struct dpct_type_975f62 {
        double r;
	double i;
} RSComplex;

typedef struct dpct_type_30855a {
        int nthreads;
	int n_nuclides;
	int lookups;
	HM_size HM;
...
typedef struct dpct_type_29f1d8 {
        RSComplex MP_EA;
	RSComplex MP_RT;
	RSComplex MP_RA;
	RSComplex MP_RF;
...
typedef struct dpct_type_8e4e21 {
        double T;
	double A;
	double F;
	int start;
...
typedef struct dpct_type_983e9f {
        int * n_poles;
